...
def main() -> None:
    ...
    if master_process:
        ...
        wandb.init(project="ml_ai_project", entity="the-golfers", name=args.run_id, config=run_config)
    ...
    if master_process:
        wandb.log({
            "final_val_loss": q_val_loss, "final_val_bpb": q_val_bpb,
            "awq_file_bytes": awq_stats["file_bytes"], "awq_compression_ratio": awq_stats["compression_ratio"],
            "awq_num_layers": awq_stats["num_awq_layers"], "awq_payload_bytes": awq_stats["payload_bytes"],
            "awq_weight_payload_bytes": awq_stats["awq_payload_bytes"], "awq_baseline_fp16_bytes": awq_stats["baseline_fp16_bytes"],
            "awq_raw_torch_bytes": awq_stats["raw_torch_bytes"], "awq_num_fp_tensors": awq_stats["num_fp_tensors"],
        })
        wandb.finish()
